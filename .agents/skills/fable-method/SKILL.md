...
How work gets done in this repo. AGENTS.md says what not to break; this skill says how to
...
2. **Goldens byte-identical** for any engine/replay/signal change — new fields ride the
   non-serialized side-channel (AGENTS.md "Extend engine records parity-safely").
