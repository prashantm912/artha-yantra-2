...
> live and both design programs (evolution + intelligence) are fully built and live-deployed (EVO E1→E6,
> INT I1→I3, live @ `173b93c1` 2026-07-12) — the frontier is now the APP Phase-4 planes (D3) + FID Phase-2–4
> remainder (D4) + owner arming rows; see `PHASE_GATES.md` for the current frontier.)**
...
<!-- scratch: docs-only classifier proof (PR #1252) -->
