...
| VWAP — default | 4.2 | FULL | engine builtin `vwap`, `SessionIndicators.sessionVwap` (`SessionIndicators.java:20`); gate reads `bank.builtin("vwap")` (`ScalperConfluenceGate.java:309`) | — |
