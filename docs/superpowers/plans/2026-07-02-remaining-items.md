...
| C5 | `evo-e5` | EVO §12 E5 (next increment; read the design §12 for scope) | EVO §12 | clean | TODO |
| C6 | `evo-e6-autonomy` | EVO §12 E6 (autonomy + FE; owner-gated arming) | EVO §12 | mixed | TODO |
| C7 | `int-i3-fe` | INT I3 FE half — compare/dossier/act views over #778's endpoints | INT §12 I3 | clean | TODO |
