...
Remaining startables: INT-I3 (needs P1-Phase-2 events/UI), EVO-E4 slice 3 + E5, D-group phases, F5 signal-analysis
backlog (owner), owner rows. Monday watches unchanged + NEW: first scalper fire populates fired_diagnostic (C4),
