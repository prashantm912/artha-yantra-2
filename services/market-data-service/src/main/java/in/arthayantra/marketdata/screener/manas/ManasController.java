...
public class ManasController {
  ...
  public record Row(
      ...
      @Schema(type = "string", types = {"string", "null"}) BigDecimal avgVol20,
      @Schema(type = "string", types = {"string", "null"}) BigDecimal avgVol50,
      @Schema(type = "string", types = {"string", "null"}) BigDecimal turnover50,
      @Schema(type = "string", types = {"string", "null"}) BigDecimal withinHighPct,
