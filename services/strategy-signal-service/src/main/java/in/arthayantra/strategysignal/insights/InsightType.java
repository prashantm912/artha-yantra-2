 ...
 * (SIGNAL_PRIORITY/DATA_TRUST/RISK_HEAT); I2 adds the context/rejection/hygiene/expiry breadth. The
 * enum grows additively as later waves add types (each type = one generator class).
 */
