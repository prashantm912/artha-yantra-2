...
public class SellDecisionRepository {
  ...
  public record SellDecisionRow(
      ...
      @Schema(type = "string", types = {"string", "null"}) BigDecimal currentPrice,
      @Schema(type = "string", types = {"string", "null"}) BigDecimal unrealizedPct,
      @Schema(type = "string", types = {"string", "null"}) BigDecimal stopLevel,
      @Schema(type = "string", types = {"string", "null"}) BigDecimal trailLevel,
